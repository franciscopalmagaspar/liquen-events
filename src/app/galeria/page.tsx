...
const photos = [
  ...
  { gradient: "from-moss/50 to-surface-elevated", label: "Teambuilding", size: "col-span-2" },
            ...
            {photos.map((p, i) => (
              ...
              >
                ...
                <div className="absolute bottom-3 left-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-xs font-medium tracking-widest uppercase text-cream/90 bg-black/30 px-3 py-1 rounded-full">
                    {p.label}
                  </span>
                </div>
              </div>
